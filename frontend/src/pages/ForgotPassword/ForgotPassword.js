...
class ForgotPassword extends Component {
    ...
    render() {
        ...
        return (
            ...
            <p>Enter your email address associated with your account. If it exists, you will receive a new password by email.</p>
            {error ? <div className="alert alert-danger col-6" role="alert">{error}</div> : null}
            {success ? <div className="alert alert-success col-6" role="alert">A new password has been sent to your email address.</div> : null}
